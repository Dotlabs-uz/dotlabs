...
const ServicesCont: React.FC<ServicesContProps> = () => {
	return (
		<>
			<section className="hidden md:grid grid-cols-3 gap-3 w-full max-w-[1400px] mx-auto p-5 bg-[rgba(255,255,255,0.5)] backdrop-blur-md rounded-[40px] relative z-10">
				<Service />
				<Service />
				<Service />
			</section>
