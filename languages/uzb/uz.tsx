const uz = {
    ...
    services_arr: [
        ...
        },
        {
            ...
            points: [
                ...
                { icon: "toggle-right", title: "Sizning ehtiyojlaringiz uchun echimlar" },
                {
                    icon: "check",
    ...
    section2: {
        ...
        secontBlockPText:"DOT LABS - da biz sizning biznesingizni keyingi bosqichga olib chiqadigan ajoyib veb-echimlarni yaratishga ishtiyoq bilan bag'ishlanganmiz.",
    ...
    aboutPage: {
        ...
        title2: "innovatsion echimlar va yuqori darajadagi professionallikni taqdim etish orqali onlayn muvaffaqiyatga erishishingizga yordam bering.",
