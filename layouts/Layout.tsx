	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content="Разработка сайта ♛ создание сайтов в Самарканде ➤ Заказать сайт в Dotlabs. 14 лет опыта. ☎ +998 (90) 504-74-94. Комплексный интернет-маркетинг и продвижение бизнеса в Интернете. Услуги нашего агентства: SEO-продвижение, Контекстная реклама в Яндекс и Google, разработка и поддержка сайтов."
				/>
			</Head>
