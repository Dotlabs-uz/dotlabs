			...
			<footer className="w-full bg-white" >
                <div className="flex items-start justify-between max-w-[1040px] w-full mx-auto" >
                    ...
                    <div className="flex flex-col items-start" >
                        <Image src="/icons/black_logo.svg" alt="" width="80" height="44" className="mb-8" />
                        <Link href="" className="font-semibold text-[44px]" >+998 (99) 911-01-11</Link>
                        <span className="font-semibold text-[22px] text-[#A3A7AC] " >Буюк Ипак Йули 52, Самарканд, Узбекистан</span>
                    </div>
                </div>
            </footer>
		</>
