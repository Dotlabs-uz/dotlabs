            ...
            <div className="w-full max-w-[1650px] mx-auto px-8 lg:px-16  grid lg:grid-cols-2 xl:grid-cols-2 xl:px-0 ">
              <div className="w-full   mb-6 lg:pr-16 lg:mb-14 xl:pr-0 ">
                ...
                <p className="text-white text-lg md:text-2xl lg:text-2xl">
                  Всегда искренны с клиентами. Слышим, предлагаем и стараемся
              ...
              <div className="w-full mb-6 xl:pl-28 lg:pr-16 xl:pr-0 lg:mb-14">
                ...
                <p className="text-white text-lg md:text-2xl lg:text-2xl">
                  Нацелены не только на качественный результат, но и на
                  комфортный и понятный процесс решения клиентских задач.
                </p>
              </div>
              <div className="w-full mb-6 lg:pr-16 lg:mb-14">
                ...
                <p className="text-white text-lg md:text-2xl lg:text-2xl">
                  Не берем проекты с политическим подтекстом. Имеем свой взгляд
              ...
              <div className="w-full mb-6 xl:pl-28 lg:pr-16 xl:pr-0 lg:mb-14">
                ...
                <p className="text-white text-lg md:text-2xl lg:text-2xl">
                  Не участвуем в фиктивных тендерах, различных закупках,
                  бартерных проектах и прочих непрозрачных схемах.
                </p>
              </div>
            </div>
          </div>
